...
<body style="margin-bottom: 100px;background-image: linear-gradient(to right top, #051937, #182b6c, #4a379f, #8b36ca, #d812eb);">
    <nav class="navbar navbar-dark bg-dark" style="-webkit-box-shadow: 0 8px 6px -6px #999;
    -moz-box-shadow: 0 8px 6px -6px #999;
    box-shadow: 0 8px 6px -6px #001;">
        <form class="form-inline">
            <a href="loginUser.php"><button class="btn btn-outline-success" style="margin-right: 5px;" type="button" id="loginBtn">Login</button></a>
            <a href="loginUser.php"><button class="btn btn-outline-warning" style="margin-right: 5px;" type="button" id="logoutBtn">Logout</button></a>
            <a href="orgReg.php"><button class="btn btn-outline-info" style="margin-right: 5px;" type="button" id="orgBtn">Organizer</button></a>
            <a href="#"><button class="btn btn-outline-info" style="margin-right: 5px;" type="button" id="profBtn">Profile</button></a>
            <a href="#"><button class="btn btn-outline-info" style="margin-right: 5px;" type="button" id="ordBtn">Order</button></a>
            <a href="#"><button class="btn btn-outline-info" style="margin-right: 5px;" type="button" id="payBtn">Payment</button></a>
